...
@Entity
public class RankedChoice implements Comparable<RankedChoice>, Serializable {
    @Id
    private Long id;
    @ManyToOne
    ...
    public RankedChoice(Candidate candidate, Long ranking) {
    ...
    public boolean equals(Object o) {
        ...
        RankedChoice that = (RankedChoice) o;
